...
function StorySkeleton() {
  return (
    <div className="flex flex-col overflow-hidden rounded-2xl border border-katha-text/8 bg-katha-text/[0.025] h-48">
      <div className="flex-1 p-5 space-y-3">
        <div className="flex items-start justify-between">
          <div className="h-5 w-3/5 animate-pulse rounded bg-katha-text/[0.07]" />
          <div className="h-4 w-16 animate-pulse rounded-full bg-katha-text/[0.07]" />
        </div>
      ...
      <div className="border-t border-katha-text/10 p-4">
        <div className="h-4 w-1/3 animate-pulse rounded bg-katha-text/[0.05]" />
      </div>
    </div>
  );
}
