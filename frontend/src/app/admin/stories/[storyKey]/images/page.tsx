...
import { StoryImageWorkspacePageClient } from './StoryImageWorkspacePageClient';
import type { StoryRouteKey } from '@/features/stories/types';

const STORY_ROUTE_KEY_REGEX = /^s1_[A-Za-z0-9]{8,32}$/;

export default async function StoryImagesPage({
  params,
}: {
  ...
  return <StoryImageWorkspacePageClient storyKey={storyKey as StoryRouteKey} />;
}
