...
export function ConfirmTextDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/70 p-4" role="dialog" aria-modal="true">
      <div className="w-full max-w-lg rounded-2xl border border-white/10 bg-katha-surface p-6">
        ...
        <div className="mt-4 rounded-xl bg-white/[0.04] p-4 text-sm text-white/55">
