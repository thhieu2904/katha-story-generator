  ...
  return (
    <article className="overflow-hidden rounded-2xl border border-katha-text/10 bg-katha-text/[0.025]">
      <div className="grid gap-0 lg:grid-cols-[minmax(0,1fr)_minmax(280px,0.78fr)]">
        <div className="p-5 sm:p-6 space-y-4">
          ...
          <div className="space-y-3 text-sm leading-6">
            ...
            <section>
              ...
              <p className="text-khmer mt-1 text-lg leading-8 text-katha-text/70">
                {page.text_km}
              </p>
            </section>
          </div>
        ...
        <div className="border-t border-katha-text/10 bg-katha-field p-5 sm:p-6 lg:border-l lg:border-t-0">
