...
const variantStyles = {
  info: 'bg-katha-primary/10 border-katha-primary/30 text-white',
    ...
    >
      ...
      {action && (
        <button
          ...
          className="rounded-lg bg-white/10 px-3 py-1.5 font-medium text-white hover:bg-white/20 disabled:opacity-50 transition-colors"
        >
          {action.label}
        </button>
      )}
